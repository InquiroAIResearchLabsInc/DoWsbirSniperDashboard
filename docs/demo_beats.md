...
| 7 | 2:10 | Click **This Sponsor Is Wrong**. Receipt toast appears in corner. | `docs/copy/disagreement_button.md` |
| 8 | 2:20 | Closing narration. | `<PLACEHOLDER_CLOSING_NARRATION>` |
| 9 | 2:30 | Show sandbox banner CTA. Point at `https://dsip-sniper.onrender.com/demo`. | `docs/copy/sandbox_banner.md` |
| 10 | 2:40 | Cut. | — |
